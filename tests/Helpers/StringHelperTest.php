...
class StringHelperTest extends TestCase
{
    ...
    public function testClassName()
    {
        ...
        $this->assertEquals('WebStone\Stdlib\Helpers\StringHelper', StringHelper::className(new StringHelper()));
        $this->assertEquals('StringHelper', StringHelper::className('WebStone\Stdlib\Helpers\StringHelper', true));
        $this->assertEquals('WebStone\Stdlib\Helpers\StringHelper', StringHelper::className('WebStone\Stdlib\Helpers\StringHelper'));
    }
